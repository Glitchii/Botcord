...
export function Base({ selectedServer, setSelectedServer }) {
    const [selectedChannel, setSelectedChannel] = useState(null);
    const [guildChannels, setGuildChannels] = useState(null);
    const [guild, setGuild] = useState(null);

    useEffect(() => {
        ipcRenderer.send('getGuild');
            ...
            <nav className="container-3w7J-x" title={`${selectedServer?.name} (server)`}>
                ...
                <div className="scroller-RmtA4e thin-1ybCId scrollerBase-289Jih fade-2kXiP2" title="Channels" orientation="vertical" id="channels" tabIndex={0} style={{ overflow: 'hidden scroll', paddingRight: '0px' }}>
                    <div className="content-3YMskv" style={{ height: '838px' }}>
                        ...
                        <Channels channels={guild?.channels} guildId={guild?.id} rulesChannel={guild?.rulesChannelID} />
                    </div>
                </div>
                ...
                <aside className="membersWrap-2h-GB4 hiddenMembers-2dcs_q" title="Members list for general-i-think (channel)">
                    <div className="members-1998pB thin-1ybCId scrollerBase-289Jih fade-2kXiP2" tabIndex={0} aria-orientation="vertical" style={{ overflow: 'hidden scroll', paddingRight: '0px' }}>
                        <div title="Members" className="content-3YMskv" style={{ height: '1352px' }}>
                            <div style={{ height: '0px' }} />
                            <h2 className="membersGroup-v9BXpm container-2ax-kl" title="new role, 1 member"><span>new
                                role — 1</span></h2>
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={0} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Rythm, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/235088799074484224/9b29bfc497a70b6cc85bb2087936f8fd.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                            ...
                            <h2 className="membersGroup-v9BXpm container-2ax-kl" title="Online, 22 members"><span>Online — 22</span></h2>
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={1} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="[j.] JesterBot, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/828363172717133874/d7994eda8d7dc99bae2ccd995b5b682d.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={2} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Apollo, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/475744554910351370/3687c38639707046ea6bf39eef01da9c.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={3} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Auttaja, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/242730576195354624/b54738816eb1cc2361d7ad09f91c2e7b.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={4} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Compiler, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/504095380166803466/bb1d99a6393e47bae563c1924a49c398.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={5} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Custom Command, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/725721249652670555/781224f90c3b841ba5b40678e032f74a.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={6} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Custom Commands, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/724847752449753140/d7c650a4fa67aa734cf441d06d412c4d.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={7} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Dank Memer, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/270904126974590976/d60c6bd5971f06776ba96497117f7f58.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={8} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Discortics™, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/739735540483752006/f1b8973226f905448d2572d6a71435d9.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={9} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Dyno, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/155149108183695360/19a5ee4114b47195fcecc6646f2380b1.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={10} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="EPIC RPG, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/555955826880413696/aca9824ea3aaac3f2d9e318394c67b39.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={11} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Groovy, Idle" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/234395307759108106/0e7adc5d634d957b7725021c067bfd87.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={12} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="I Run Code, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/730885117656039466/fdddbc5f23e8f7f637a6c883d238d3ab.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={13} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="MEE6, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/159985870458322944/b50adff099924dd5e6b72d13f77eb9d7.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={14} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Nadeko, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/116275390695079945/0de545b2efc0baeda0fbf458f3f884dc.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={15} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Pogy, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/767705905235099658/07a84cd45e1f0ad21a482ab4bbfcf57a.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={16} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="ProBot ✨, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/282859044593598464/156a0d2872579f1ffcaa5d2127239bfd.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={17} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Tatsu, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/172002275412279296/43fc1879641f6239d6e4038eaa7dabbc.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={18} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="TicTacToe, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/566009524574617600/65d84daef26fee38488e5735e1ad271f.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={19} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Trivia, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/337654994461261825/cc7dddaf3195aff4cbc8af826beefb1e.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={20} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Troy, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/663074487335649292/576eb5f13519b9da10ba7807bdd83fab.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={21} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="YAGPDB.xyz, Online" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/204255221017214977/2fa57b425415134d4f8b279174131ad6.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(139, calc(var(--saturation-factor, 1) * 47.3%), 43.9%)" mask="url(#svg-mask-status-online)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <div className="member-3-YXUe container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={22} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Λcє, Idle" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-status-round-32)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/642791754160013312/73b507896ea2ae338d28f28076582bbe.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                                <rect width={10} height={10} x={22} y={22} fill="hsl(38, calc(var(--saturation-factor, 1) * 95.7%), 54.1%)" mask="url(#svg-mask-status-idle)" className="pointerEvents-2zdfdO" />
                                            </svg>
                                        </div>
                            ...
                            <h2 className="membersGroup-v9BXpm container-2ax-kl" title="Offline, 5 members"><span>Offline — 5</span></h2>
                            <div className="member-3-YXUe offline-3nJYBR container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={23} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Asdf" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-default)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/691755573607137281/cfb4ba62d45af5961ded0d81522f48f4.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <div className="member-3-YXUe offline-3nJYBR container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={24} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="King-bot" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-default)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/715942614712713247/c6bc2db7da813db7de7d116437e68fe9.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <div className="member-3-YXUe offline-3nJYBR container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={25} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Quack" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-default)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/808016850981486602/8dc715a07883bc1bc93e4ebb4be361cc.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <div className="member-3-YXUe offline-3nJYBR container-2Pjhx- clickable-1JJAn8" tabIndex={-1} index={26} >
                                <div className="layout-2DM8Md">
                                    <div className="avatar-3uk_u9">
                                        <div className="wrapper-3t9DeA" title="Roi" style={{ width: '32px', height: '32px' }}>
                                            <svg width={40} height={32} viewBox="0 0 40 32" className="mask-1l8v16 svg-2V3M55">
                                                <foreignObject x={0} y={0} width={32} height={32} mask="url(#svg-mask-avatar-default)">
                                                    <div className="avatarStack-2Dr8S9">
                                                        <img src="https://cdn.discordapp.com/avatars/663073532804202517/90a731dda33740d0b248afe74d2df4fa.webp?size=128" alt=" " className="avatar-VxgULZ" /></div>
                                                </foreignObject>
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="content-3QAtGj">
                                        <div className="nameAndDecorators-5FJ2dg">
                                            ...
                                            <svg title="Server Owner" className="ownerIcon-2NH9FM icon-1A2_vz" width={24} height={24} viewBox="0 0 16 16">
