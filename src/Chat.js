...
export default function Chat({ selectedServer, setSelectedServer, selectedChannel, setSelectedChannel, selectedChannelMessages, setSelectedChannelMessages }) {
    const chat = useRef(0);
    const toggleMembersList = () => chat?.current.classList.toggle('noMemberList');

    return !selectedChannel ? <div></div> : <div className="chat chat-3bRxxu-rpl" ref={chat}>
        <div className="uploadArea-1qnBZm uploadArea-3QgLtW">
            <div className="uploadDropModal-2kTwbc">
                ...
                <div className="inner-3nWsbo">
                    ...
                    <div className="title-2Vtl4y">Upload to <strong>#{selectedChannel.name}</strong></div>
        ...
        <section className="title-3qD0b- container-1r6BKw themed-ANHk51" data-title="Channel header">
            <div className="children-19S4PO">
                <div className="iconWrapper-2OrFZ1" data-title="Text channel" tabIndex={-1}>
                ...
                <h3 className="title-29uC1r base-1x0h_U size16-1P40sf">{selectedChannel.name}</h3>
            </div>
            <div className="toolbar-1t6TWx">
                <div className="icon-iDUzSK iconWrapper-2OrFZ1 clickable-3rdHwn" data-title="Threads" tabIndex={0}>
                ...
                <div className="iconWrapper-2OrFZ1 clickable-3rdHwn" title={`Mute channel ${selectedChannel.name}`} tabIndex={0}>
                    <svg x={0} y={0} className="icon-22AiRD" width={24} height={24} viewBox="0 0 24 24" fill="none">
                ...
                <div className="iconWrapper-2OrFZ1 clickable-3rdHwn" data-title="Pinned messages" tabIndex={0}>
                ...
                <div className="iconWrapper-2OrFZ1 clickable-3rdHwn selected-1GqIat" data-title="Hide Member List" tabIndex={0} onClick={toggleMembersList}>
                    <svg x={0} y={0} className="icon-22AiRD" width={24} height={24} viewBox="0 0 24 24">
                ...
                <div className="search-36MZv-">
                    <div className="search-2oPWTC">
                        <div className="searchBar-3dMhjb" data-title="Search" aria-owns="search-results">
                ...
                <div className="iconWrapper-2OrFZ1 clickable-3rdHwn" data-title="Inbox" tabIndex={0}>
                    <svg x={0} y={0} className="icon-22AiRD" width={24} height={24} viewBox="0 0 24 24" fill="none">
                ...
                <a tabIndex={-1} className="anchor-3Z-8Bb anchorUnderlineOnHover-2ESHQB" href="https://support.discord.com" rel="noreferrer noopener" target="_blank">
                    <div className="iconWrapper-2OrFZ1 clickable-3rdHwn" data-title="Help" tabIndex={0}>
                        <svg x={0} y={0} className="icon-22AiRD" width={24} height={24} viewBox="0 0 24 24">
        ...
        <div className="content-yTz4x3">
            <main className="chatContent-a9vAAp" title={`${selectedChannel.name} (channel)`}>
                <div className="messagesWrapper-1sRNjr group-spacing-16">
                    <div className="scroller-2LSbBU auto-Ge5KZx scrollerBase-289Jih disableScrollAnchor-3V9UtP" dir="ltr" tabIndex={-1} style={{ overflow: 'hidden scroll', paddingRight: '0px' }}>
                        <div className="scrollerContent-WzeG7R content-3YMskv">
                            <div className="scrollerInner-2YIMLh" title={`Messages in ${selectedChannel.name}`} tabIndex={0}>
                                <div className="container-3RCQyg">
                                    <div className="emptyChannelIcon" />
                                    <h1 className="header-3uLluP base-1x0h_U size32-o_H79z">Welcome to {selectedChannel.name}!</h1>
                                    <div className="size16-1P40sf description-1sDbzZ">This is the start of the #{selectedChannel.name} channel.</div>
                                </div>
                                <ChatMessages selectedChannelMessages={selectedChannelMessages} setSelectedChannelMessages={setSelectedChannelMessages}/>
            ...
            <SideMemberList selectedServer={selectedServer} setSelectedServer={setSelectedServer} selectedChannel={selectedChannel} />
        </div>
    </div>
}
